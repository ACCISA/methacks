                ...
                <div className=" mt-36 text-xl text-center my-4 flex flex-col items-center">
                    ...
                    {username && families.map((fam) => (
                        <Link to={"/manage/" + fam._id}>
                                ...
                                <button className='rounded-md border-2 flex bg-white hover:underline underline-offset-4 text-black m-4 p-2 mt-4 w-auto' key={fam._id}> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-2">
