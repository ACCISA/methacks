                    ...
                    <div className="border p-2">
                        {fam && (members.map((member) => (
                            <div className="flex border justify-between">
                                ...
                                <button value={member.member} onClick={handleRemoveMember} className="mb-2 w-8 text-center items-center align-items rounded-full hover:bg-red-500"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-1">
